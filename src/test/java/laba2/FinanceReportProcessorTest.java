...
public class FinanceReportProcessorTest {
    ...
    public void getPaymentsSecondName() {
        ...
        Payment payment5 = new Payment("Первак Первашевич Универович", 9, 10, 2005, 1234);
        ...
        FinanceReport financeReport = new FinanceReport(new Payment[]{payment1, payment2, payment3, payment4, payment5},
                "Директоров Директор Директорович",
                "26.11.24");
        FinanceReport financeReport2 = new FinanceReport(new Payment[]{payment2, payment5},
                "Директоров Директор Директорович",
                "26.11.24");
